# # RP2350A-DevBoard Project Hardware Design Files

## Contents
This folder contains the hardware design files for the RP2350A-DevBoard project. The main components include:
- Schematic diagrams
- PCB layouts
